...
#ifndef TRANSFORMS_REDUNDANTRBSSELECTORTASK_TASK_HPP
#define TRANSFORMS_REDUNDANTRBSSELECTORTASK_TASK_HPP

#include "transforms/RedundantRBSSelectorTaskBase.hpp"

namespace transforms {

    /*! \class RedundantRBSSelectorTask
     ...
     * In order to modify the interfaces you should (re)use oroGen and rely on the
     associated workflow.
     * Task for swithing between a main and a secondary rigid body state source. It
     forwards
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','transforms::RedundantRBSSelectorTask')
     end
     \endverbatim
    ...
    public:
         ...
         * Stopped state.
         */
        RedundantRBSSelectorTask(
            std::string const& name = "transforms::RedundantRBSSelectorTask");

        /** Default deconstructor of RedundantRBSSelectorTask
         */
        ~RedundantRBSSelectorTask();
